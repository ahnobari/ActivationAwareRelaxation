...
def merge_and_save_models(args: argparse.Namespace, finetuned_model_names: list, models_to_merge: list, finetuned_tokenizers: list,
                          finetuned_configs: list, logger: logging.Logger, merging_method: MergingMethod, save_path: str):
    """
...
parser.add_argument("--save_model_path", type=str, default="./merged", help="path to save the merged model")
...
if __name__ == "__main__":
    ...
    merge_and_save_models(args=args, finetuned_model_names=finetuned_model_names, models_to_merge=models_to_merge, finetuned_tokenizers=finetuned_tokenizers,
                          finetuned_configs=finetuned_configs, logger=logger, merging_method=merging_method, save_path=args.save_model_path)
